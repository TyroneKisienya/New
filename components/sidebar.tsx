...
export function Sidebar() {
  ...
  // Sidebar content extracted so we can reuse it
  const SidebarContent = ({ isMobile = false }: { isMobile?: boolean }) => (
    <div className={`h-full overflow-y-auto scrollbar-hide bg-gray-900 w-full ${
      isMobile ? 'pb-safe' : ''
    }`}>
      {/* Header */}
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <div className="hidden lg:block fixed top-0 left-0 h-full bg-gray-900 w-64 z-30 shadow-xl">
        <SidebarContent />
      </div>
